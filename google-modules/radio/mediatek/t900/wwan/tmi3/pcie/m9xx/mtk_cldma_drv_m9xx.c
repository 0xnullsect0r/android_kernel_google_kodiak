...
struct cldma_hw_regs mtk_cldma_regs_m9xx = {
	...
	.reg_cldma_rq1_done_cnt = REG_CLDMA_RQ1_GPD_DONE_CNT,
	.reg_cldma_tq1_done_cnt = REG_CLDMA_TQ1_GPD_DONE_CNT,
...
struct cldma_drv_ops cldma_drv_ops_m9xx = {
	.cldma_drv_dump = mtk_cldma_drv_dump,
