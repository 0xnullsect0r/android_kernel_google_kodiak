 ...
 *
 *   hash: 9958f5e8184046ac1386bf2d46d0a9b705c104fc
 *
...
enum AOC_COMMAND {
  ...
  CMD_DBG_WATCHDOG_TRIGGER_V2_ID = 59, /* [0x003b] ->  struct CMD_WATCHDOG_TRIGGER */
  ...
  CMD_AOCX_TAP_SET_JITTER_BUFFER_ID = 207, /* [0x00cf] ->  struct CMD_AOCX_TAP_SET_JITTER_BUFFER */
 ...
 * Structure associated with the following commands:
 *
 *   CMD_DBG_WATCHDOG_TRIGGER_V2_ID, UUID: 5c185496a9ddd8aa034ddaa744809cce
 */
struct CMD_WATCHDOG_TRIGGER {
  struct CMD_CORE_GENERIC parent;
  uint8_t force_hw_wdt;
  uint8_t force_sw_wdt;
} __attribute__((packed));
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AOCX_TAP_SET_JITTER_BUFFER_ID, UUID: 7d6d81489aa14aad9046939d553f77ed
 */
...
static inline int AocInterfaceCheck(const void * addr, int size) {
  static const uint8_t uuid_array[AOC_UUID_ENTRIES][AOC_UUID_SIZE] = { 
      ...
      { 0x5c, 0x18, 0x54, 0x96, 0xa9, 0xdd, 0xd8, 0xaa, 0x03, 0x4d, 0xda, 0xa7, 0x44, 0x80, 0x9c, 0xce},
      ...
      { 0x7d, 0x6d, 0x81, 0x48, 0x9a, 0xa1, 0x4a, 0xad, 0x90, 0x46, 0x93, 0x9d, 0x55, 0x3f, 0x77, 0xed},
