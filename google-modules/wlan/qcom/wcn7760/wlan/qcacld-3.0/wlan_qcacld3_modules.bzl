"""This module defines the QCACLD 3.0 kernel module build rules."""
...
def define_module_for_target_variant_chipset(name, target, variant, chipset):
    """Defines a module for a given name, target, variant, and chipset.

    Args:
      name: The name of the module rule.
      target: The target device
      variant: The build variant
      chipset: The chipset identifier
    """
    ...
    deps = select({
        ...
        "//private/google-modules/wlan/wonder:wonder",
        "//private/google-modules/wlan/wonder:wonder_headers",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_cnss_prealloc",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_qrtr_qrtr",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_qrtr_mhi",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_qmi_helpers",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_mhi_host",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_cnss_utils",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_cnss2",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_cnss_nl",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_cnss_plat_ipc_qmi_svc",
        "//private/google-modules/wlan/qcom/wcn7760/cnss2:cnss2_wlan_firmware_service",
    ]
    ...
    for e in feature_grep_map:
        grep_src_files.append("//common:{}".format(e["file"]))

    depset_src = depset(grep_src_files)
    native.genrule(
        name = "{}_grep_defines".format(tvc),
        outs = ["configs/grep_defines_{}.h".format(tvc)],
        srcs = depset_src.to_list(),
        cmd = cmd,
    )
    ...
    copts.append("-include")
    copts.append("configs/grep_defines_consolidate_wcn7760.h")
    copts.append("-DCONFIG_ARCH_MSM=n")
    copts.append("-Wno-missing-prototypes")
    ...
    srcs = native.glob(iglobs, allow_empty = True) + _fixed_srcs
    ...
    ddk_module(
        name = module_name,
        srcs = srcs + ["configs/grep_defines_consolidate_wcn7760.h"],
        includes = ipaths + ["."],
        kconfig = kconfig,
        defconfig = defconfig,
