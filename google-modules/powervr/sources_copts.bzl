...
CONDITIONAL_SRCS = {
    ...
    "CONFIG_POWERVR_ROGUE_PDUMP": {
        True: [
            ...
            "pvrsrvkm/generated/volcanic/pdumpctrl_bridge/client_pdumpctrl_direct_bridge.c",
...
POWERVR_COMMON_SRCS = [
    ...
    "pvrsrvkm/services/server/devices/rgxfwimageutils.c",
    "pvrsrvkm/services/server/devices/rgxlayer_impl_common.c",
]
...
POWERVR_VOLCANIC_SRCS = [
    ...
    "pvrsrvkm/services/server/devices/volcanic/rgxstartstop.c",
    "pvrsrvkm/services/server/devices/volcanic/rgxta3d.c",
    "pvrsrvkm/services/system/common/vmm_type_stub.c",
    "pvrsrvkm/services/server/devices/volcanic/rgxlayer_impl.c",
