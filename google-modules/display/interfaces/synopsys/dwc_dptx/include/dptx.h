...
#define DPTX_MAX_VS_LEVEL 3
#define DPTX_MAX_PE_LEVEL 3
#define DPTX_MAX_VS_PE_SUM 3
...
/* EDID HF-EEODB */
#define EDID_EEODB_TAG		7
#define EDID_EEODB_EXT_TAG	0x78
