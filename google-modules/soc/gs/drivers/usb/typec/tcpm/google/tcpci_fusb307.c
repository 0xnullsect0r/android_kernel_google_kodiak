...
static int fusb307b_update_bits16(struct fusb307b_plat *chip, unsigned int reg,
				  u16 mask, u16 val)
{
	FUSB307B_UPDATE_BITS(16, chip, reg, mask, val);
}

static int fusb307b_update_bits8(struct fusb307b_plat *chip, unsigned int reg,
				 u8 mask, u8 val)
{
