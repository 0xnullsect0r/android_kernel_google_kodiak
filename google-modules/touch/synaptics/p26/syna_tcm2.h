...
enum custom_report_types {
	...
	REPORT_INVALID_GESTURE_EVENT = 0xCA,
};
...
#define SIMULATION_DATA_SIZE	64
...
struct syna_tcm {
	...
	u8 sync_lost_state;
	u8 sync_lost_state_last;
	bool abnormal_gesture_reported;
	u8 metadata[METADATA_SIZE];
	u8 simulation_data[SIMULATION_DATA_SIZE];
